    ...
    public static void main(String args[])
    {
        ...
        do {
            ...
            if(userInput.hasNextInt()) {
                ...
                {    
                    System.out.println("HURRAY!, Your Number is Correct. You Win the Game!");
                    break;
                }
                else if (userGuessNumber < secretNumber)
                    System.out.println("Oh! Your  Guess Number is too small.");
                else if (userGuessNumber > secretNumber)
                    System.out.println(" Oops! Your Guess Number is too Big.");
                if(attempt == 5) {
